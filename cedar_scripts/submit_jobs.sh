...
JOBTIME=`date` sbatch --time=1-20:00:00 --mem-per-cpu=16G --array=4,8,590 --job-name=wcs_hkh_g "$DATATOOLS/cedar_scripts/run_WCSim_job.sh" "$name" "$data_dir" -n 3000 -e 0 -E 1000 -P gamma -o z -d 4pi -p unif -y 3287 -R 3240 -g HyperK_HybridmPMT -m